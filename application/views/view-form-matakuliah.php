...
<body>
 ...
 <td>:</td>
 <td>
 <input type="radio" name="stts" value="Unggulan" <?php echo set_radio('stts', 'Unggulan'); ?>>Unggulan
 <input type="radio" name="stts" value="Tidak Unggulan" <?php echo set_radio('stts', 'Tidak Unggulan'); ?>>Tidak Unggulan
</radio>
 </td>
 </tr>
 <tr>
